...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1570317080ltr&server=1">
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/printview.css?v=5.1.3" media="print" id="printcss">
    <title>localhost:81 / localhost | phpMyAdmin 5.1.3</title>
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=noteTaking&table=role">`noteTaking`.`role`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=noteTaking&table=contribution">`noteTaking`.`contribution`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=noteTaking&table=note">`noteTaking`.`note`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=noteTaking&table=user">`noteTaking`.`user`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="5868422776294b6874727228583c7579">
