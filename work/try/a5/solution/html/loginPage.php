        ...
        <div class="login">
            <form id="login" method="get">
                ...
                <div class = "tipFieldContainer">
                    <input type="email" name="Uname" class="inField" id="emailField" placeholder="Username">
                ...
                <!-- password field -->
                <div class = "tipFieldContainer">
                    <input type="password" name="Pass" class="inField" id="passwordField" placeholder="Password">
